...
class Individual:
    ...
    def dominates(self, other):#others = individual()
        """"
        ...
        """
        if (self.objectives[0] < other.objectives[0] and self.objectives[1] <= other.objectives[1])or\
            (self.objectives[0] <= other.objectives[0] and self.objectives[1] < other.objectives[1]):
            return 1
        elif (self.objectives[0] > other.objectives[0] and self.objectives[1] >= other.objectives[1])or\
            (self.objectives[0] >= other.objectives[0] and self.objectives[1] < other.objectives[1]):
            return -1
        else:
            return 0 
...
class Population:
    ...
    def computeFrontRanks(self):
        ...
        for menber in self.pop :
            rank = 0
            for others in self.pop:
                    rank += menber.dominates(others)
